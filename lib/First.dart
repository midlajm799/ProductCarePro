    ...
    return Scaffold(
        body: Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Image.asset("assets/logo1.jpg",height: height*.35,width: width*.7,),
                Stack(
                  children: [
                    Text(
                      'PRODUCT',
                ...
                Text(
                  """Stay Covered,Stay Connected
                   With Us.""",
                  style: TextStyle(color: const Color(0xFF1E1E1E), fontSize: height*.016,fontWeight: FontWeight.w500),
                ),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(
                      borderRadius:
                      BorderRadius.circular(height*.30), // Add rounded corners
                    ),
                  ),
                  child: const Text(
                    "Let's Go!",
